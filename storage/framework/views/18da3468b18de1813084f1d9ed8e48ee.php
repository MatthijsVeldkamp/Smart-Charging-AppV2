...
<?php $__env->startSection('title', 'Advance'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['title' => 'Cards','pagetitle' => 'Advance']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Cards','pagetitle' => 'Advance']); ?>
...
<?php endif; ?>
      ...
      <div class="row row-cols-1 row-cols-xl-2">
          ...
          <div class="card">
            <div class="row g-0">
              <div class="col-md-4 border-end">
                <div class="p-3">
                  <img src="<?php echo e(URL::asset('build/images/gallery/09.png')); ?>" class="w-100 rounded-start" alt="...">
                </div>
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <div class="row g-0">
              <div class="col-md-4 border-end">
                <div class="p-3">
                  <img src="<?php echo e(URL::asset('build/images/gallery/11.png')); ?>" class="w-100 rounded-start" alt="...">
                </div>
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <div class="row g-0">
              <div class="col-md-4 border-end">
                <div class="p-3">
                  <img src="<?php echo e(URL::asset('build/images/gallery/12.png')); ?>" class="w-100 rounded h-100" alt="...">
                </div>
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <div class="row g-0">
              <div class="col-md-4 border-end">
                <div class="p-3">
                  <img src="<?php echo e(URL::asset('build/images/gallery/10.png')); ?>" class="w-100 rounded h-100" alt="...">
                </div>
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div class="col">
          <div class="card">
            <img src="<?php echo e(URL::asset('build/images/gallery/13.png')); ?>" class="img-fluid card-img-top" alt="">
            <div class="card-body p-4">
              ...
              <div class="mt-5">
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-4">
                  <div class="col">
                    <div class="text-center">
                      <img src="<?php echo e(URL::asset('build/images/orders/01.png')); ?>" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Logo Design</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="<?php echo e(URL::asset('build/images/orders/02.png')); ?>" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Whiteboard & Animated</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="<?php echo e(URL::asset('build/images/orders/03.png')); ?>" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Voice Over</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="<?php echo e(URL::asset('build/images/orders/04.png')); ?>" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Wordpress</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="<?php echo e(URL::asset('build/images/orders/05.png')); ?>" class="img-fluid rounded" alt="">
                      <h5 class="mb-0 mt-3">Articles & Blog Posts</h5>
                    </div>
                  </div>
                  <div class="col">
                    <div class="text-center">
                      <img src="<?php echo e(URL::asset('build/images/orders/06.png')); ?>" class="img-fluid rounded" alt="">
        ...
        <div class="col">
                ...
                <div class="col">
                  <div class="card shadow-none bg-voilet mb-0" style="height: 160px;">
                    <div class="card-body">
                      ...
                      <img src="<?php echo e(URL::asset('build/images/cat/01.png')); ?>" class="position-absolute end-0 bottom-0" width="140" alt="">
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card shadow-none bg-success mb-0" style="height: 160px;">
                    <div class="card-body">
                      ...
                      <img src="<?php echo e(URL::asset('build/images/cat/02.png')); ?>" class="position-absolute end-0 bottom-0" width="90" alt="">
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card shadow-none bg-dark-blue mb-0" style="height: 160px;">
                    <div class="card-body">
                      ...
                      <img src="<?php echo e(URL::asset('build/images/cat/03.png')); ?>" class="position-absolute end-0 bottom-0" width="120" alt="">
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card shadow-none bg-danger mb-0" style="height: 160px;">
                    <div class="card-body">
                      ...
                      <img src="<?php echo e(URL::asset('build/images/cat/04.png')); ?>" class="position-absolute end-0 bottom-0 m-2" width="160"
                        alt="">
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card shadow-none bg-orange mb-0" style="height: 160px;">
                    <div class="card-body">
                      ...
                      <img src="<?php echo e(URL::asset('build/images/cat/05.png')); ?>" class="position-absolute end-0 bottom-0" width="130" alt="">
                    </div>
                  </div>
                </div>
                <div class="col">
                  <div class="card shadow-none bg-indigo mb-0" style="height: 160px;">
                    <div class="card-body">
                      ...
                      <img src="<?php echo e(URL::asset('build/images/cat/06.png')); ?>" class="position-absolute end-0 bottom-0 m-2" width="200"
                        alt="">
                    </div>
                  </div>
                </div>
          ...
          <div class="card">
            <img src="<?php echo e(URL::asset('build/images/gallery/15.png')); ?>" class="card-img" alt="...">
          ...
          <div class="d-flex align-items-center gap-3">
            <div class="card rounded-4">
              <img src="<?php echo e(URL::asset('build/images/gallery/16.png')); ?>" class="card-img rounded-4" alt="...">
              <div class="card-img-overlay">
            ...
            <div class="card rounded-4">
              <img src="<?php echo e(URL::asset('build/images/gallery/17.png')); ?>" class="card-img rounded-4" alt="...">
              <div class="card-img-overlay">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Thijsie/Downloads/main-files/Matoxi_Laravel_v1.0.0/Admin/resources/views/component-cards-advance.blade.php ENDPATH**/ ?>