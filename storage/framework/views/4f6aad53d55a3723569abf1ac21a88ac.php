...
<?php $__env->startSection('title', 'Matoxi'); ?>

<?php $__env->startSection('content'); ?>
    <?php if (isset($component)) { $__componentOriginal8b54caccbdedc8030792c13949386bbd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8b54caccbdedc8030792c13949386bbd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['title' => 'Dashboard','pagetitle' => 'Matoxi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dashboard','pagetitle' => 'Matoxi']); ?>
                ...
                <div class="d-flex align-items-start justify-content-between mb-3">
                  ...
                  <div class="d-flex flex-column gap-4">
                     <div class="d-flex align-items-center gap-4">
                       <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                          <img src="<?php echo e(URL::asset('build/images/projects/angular.png')); ?>" width="30" alt="">
                        </div>
                          <div class="">
                     ...
                     <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="<?php echo e(URL::asset('build/images/projects/react.png')); ?>" width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="<?php echo e(URL::asset('build/images/projects/vue.png')); ?>" width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="<?php echo e(URL::asset('build/images/projects/bootstrap.png')); ?>" width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="<?php echo e(URL::asset('build/images/projects/magento.png')); ?>" width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="<?php echo e(URL::asset('build/images/projects/django.png')); ?>" width="30" alt="">
                       </div>
                         <div class="">
                    ...
                    <div class="d-flex align-items-center gap-4">
                      <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                       <div class="wh-48 d-flex align-items-center justify-content-center rounded-3 border">
                         <img src="<?php echo e(URL::asset('build/images/projects/python.png')); ?>" width="30" alt="">
                       </div>
                         <div class="">
                ...
                <div class="d-flex flex-column justify-content-between gap-4">
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/17.png')); ?>" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/18.png')); ?>" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/19.png')); ?>" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/20.png')); ?>" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/05.png')); ?>" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/08.png')); ?>" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/07.png')); ?>" width="32" alt="">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                      <img src="<?php echo e(URL::asset('build/images/apps/12.png')); ?>" width="32" alt="">
         ...
         <div class="col-12 col-xl-12 d-flex">
          <div class="card w-100 rounded-4">
            <div class="card-body">
              ...
              <div class="d-flex flex-column gap-4">
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/orders/01.png')); ?>" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/orders/08.png')); ?>" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/orders/03.png')); ?>" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/orders/04.png')); ?>" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/orders/05.png')); ?>" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/orders/06.png')); ?>" width="75" class="rounded-3" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/orders/07.png')); ?>" width="78" class="rounded-3" alt="">
                  <div class="flex-grow-1">
...
<?php $__env->startSection('scripts'); ?>
  ...
  <script src="<?php echo e(URL::asset('build/js/index.js')); ?>"></script>
  <script src="<?php echo e(URL::asset('build/plugins/peity/jquery.peity.min.js')); ?>"></script>
  <script>
    $(".data-attributes span").peity("donut")
  </script>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Thijsie/Downloads/main-files/Matoxi_Laravel_v1.0.0/Admin/resources/views/index.blade.php ENDPATH**/ ?>