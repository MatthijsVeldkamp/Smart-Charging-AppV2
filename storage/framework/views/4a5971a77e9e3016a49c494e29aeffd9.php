...
unset($__errorArgs, $__bag); ?>" id="inputEmailAddress" name="email" value="admin@gmail.com" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" id="inputChoosePassword" value="12345678" name="password"
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6">
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
      ...
      <div class="col-lg-6 d-lg-flex d-none">
        <div class="p-3 rounded-4 w-100 d-flex align-items-center justify-content-center bg-light">
          <img src="<?php echo e(URL::asset('build/images/auth/login1.png')); ?>" class="img-fluid" alt="">
        </div>
      </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Thijsie/Downloads/main-files/Matoxi_Laravel_v1.0.0/Admin/resources/views/auth/login.blade.php ENDPATH**/ ?>