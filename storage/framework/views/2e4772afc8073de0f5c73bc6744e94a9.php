...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-title','data' => ['title' => 'Dashboard','pagetitle' => 'Alternate']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Dashboard','pagetitle' => 'Alternate']); ?>
                ...
                <div class="d-flex flex-column gap-4">
                   <div class="d-flex align-items-center gap-3">
                     <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                         <img src="<?php echo e(URL::asset('build/images/county/01.png')); ?>" width="40" alt="">
                         <div class="">
                   ...
                   <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="<?php echo e(URL::asset('build/images/county/02.png')); ?>" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="<?php echo e(URL::asset('build/images/county/03.png')); ?>" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="<?php echo e(URL::asset('build/images/county/04.png')); ?>" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="<?php echo e(URL::asset('build/images/county/05.png')); ?>" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="<?php echo e(URL::asset('build/images/county/06.png')); ?>" width="40" alt="">
                        <div class="">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="d-flex align-items-center gap-3 flex-grow-1 flex-shrink-0">
                        <img src="<?php echo e(URL::asset('build/images/county/07.png')); ?>" width="40" alt="">
                        <div class="">
                ...
                <div class="d-flex flex-column gap-4">
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="<?php echo e(URL::asset('build/images/apps/11.png')); ?>" width="30" alt="">
                    </div>
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="<?php echo e(URL::asset('build/images/apps/10.png')); ?>" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="<?php echo e(URL::asset('build/images/apps/13.png')); ?>" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="<?php echo e(URL::asset('build/images/apps/01.png')); ?>" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="<?php echo e(URL::asset('build/images/apps/02.png')); ?>" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="<?php echo e(URL::asset('build/images/apps/06.png')); ?>" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="wh-48 d-flex align-items-center justify-content-center rounded-circle border">
                      <img src="<?php echo e(URL::asset('build/images/apps/04.png')); ?>" width="30" alt="">
                    </div>
                    <div class="flex-grow-1">
        ...
        <div class="col-12 col-xl-4 d-flex">
          <div class="card w-100 rounded-4">
            ...
            <div class="card-body">
              <div class="d-flex flex-column gap-3">
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/top-products/01.png')); ?>" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/top-products/02.png')); ?>" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/top-products/03.png')); ?>" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/top-products/04.png')); ?>" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/top-products/05.png')); ?>" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/top-products/06.png')); ?>" width="55" alt="">
                  <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center gap-3">
                  <img src="<?php echo e(URL::asset('build/images/top-products/07.png')); ?>" width="55" alt="">
                  <div class="flex-grow-1">
...
<?php $__env->startSection('scripts'); ?>
  ...
  <script src="<?php echo e(URL::asset('build/js/index2.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Thijsie/Downloads/main-files/Matoxi_Laravel_v1.0.0/Admin/resources/views/index2.blade.php ENDPATH**/ ?>