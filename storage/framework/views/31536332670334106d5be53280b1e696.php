<aside class="sidebar-wrapper">
    <div class="sidebar-header">
      <div class="logo-icon">
        <img src="<?php echo e(URL::asset('build/images/logo-icon.png')); ?>" class="logo-img" alt="">
      </div>
    ...
    <div class="sidebar-bottom gap-4">
        ...
        <div class="dropdown dropup-center dropup dropdown-laungauge">
          <a class="dropdown-toggle dropdown-toggle-nocaret footer-icon" href="avascript:;" data-bs-toggle="dropdown"><img src="<?php echo e(URL::asset('build/images/county/02.png')); ?>" width="22" alt="">
          </a>
          <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/01.png')); ?>" width="20" alt=""><span class="ms-2">English</span></a>
            </li>
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/02.png')); ?>" width="20" alt=""><span class="ms-2">Catalan</span></a>
            </li>
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/03.png')); ?>" width="20" alt=""><span class="ms-2">French</span></a>
            </li>
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/04.png')); ?>" width="20" alt=""><span class="ms-2">Belize</span></a>
            </li>
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/05.png')); ?>" width="20" alt=""><span class="ms-2">Colombia</span></a>
            </li>
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/06.png')); ?>" width="20" alt=""><span class="ms-2">Spanish</span></a>
            </li>
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/07.png')); ?>" width="20" alt=""><span class="ms-2">Georgian</span></a>
            </li>
            <li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="<?php echo e(URL::asset('build/images/county/08.png')); ?>" width="20" alt=""><span class="ms-2">Hindi</span></a>
            </li>
          </ul>
        </div>
...
</aside><?php /**PATH /Users/Thijsie/Downloads/main-files/Matoxi_Laravel_v1.0.0/Admin/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>